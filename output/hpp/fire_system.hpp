...
#define SMOKE_NO_SMOKE_OFF_ALARM_ALARM_ON 0
#define SMOKE_SMOKE_OFF_ALARM_ALARM_ON 1
#define SMOKE_NO_SMOKE_OFF_ALARM_ALARM_OFF 2
...
#define SMOKE_SMOKE_ON_ALARM_ALARM_ON 7
#define SMOKE_NO_SMOKE_ON_ALARM_ALARM_OFF 8
