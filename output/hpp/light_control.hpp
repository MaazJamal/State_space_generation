...
#define OCC_OC_OFF_LIGHT_SWITCH_ON 3
#define OCC_NOC_OFF_LIGHT_SWITCH_OFF 4
#define OCC_OC_OFF_LIGHT_SWITCH_OFF 5
#define OCC_NOC_ON_LIGHT_ON 6
#define OCC_OC_ON_LIGHT_ON 7
#define OCC_NOC_ON_LIGHT_OFF 8
#define OCC_NOC_ON_LIGHT_SWITCH_ON 9
#define OCC_OC_ON_LIGHT_SWITCH_ON 10
#define OCC_NOC_ON_LIGHT_SWITCH_OFF 11
